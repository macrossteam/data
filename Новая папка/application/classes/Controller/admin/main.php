...
class  Controller_Admin extends Controller_BaseUser {
	
	public function action_index()
	{	
		$this->template->content="Это админка";
	}
	public function action_listuser()
		{	
			...
			if(isset($_GET['delete_user']))
			{
				...
				$user->del($id);
				HTTP::redirect('admin/main/listuser');
			}
	...
	public function action_listorders()
	{
			...
			{	$session = Session::instance();
				...
				HTTP::redirect('admin/main/order');
			}
			if(isset($_GET['id_user']))
			{	$id = Arr::get($_GET,'id_user','');
			
				$_SESSION['iduser']=$id;
				HTTP::redirect('admin/main/userinf');
			}
